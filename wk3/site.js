...
function loadData() {
    ...
    const app = document.getElementById('app');// get from html (line 70)
    app.innerHTML = '';
    app.scrollTo(0,0);
...
function createMobNode(mob, i, showDetails = false) {
    ...
    div.id = i;
    img.src = mob.img;// pass in property

    //Loop through each iteration to get each obj
    if (showDetails) {
        ...
        h2.innerText = mob.type;// Set the innerText to mob.type
