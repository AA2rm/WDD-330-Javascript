...
/************************************************************
 * //Use the call() method to invoke the hello function  
 * &  provide an argument for ea. obj
************************************************************/
...
/************************************************************
 * Write a square function to save each result in a casche
 *  obj that's a property of te function.
************************************************************/
function square(x){
...
/************************************************************
 * /Write a welcome message to the console, then eliminates 
 * all the temporary variables used in th message 
************************************************************/
(function() {
...
/************************************************************
 * Write a function to return a random integer btn 2 values 
 * that are arguments
************************************************************/
...
/************************************************************
 * Invoke the returnHello function to return a function 
 * after the message log
************************************************************/
returnHello()
returnHello() //called
...
/************************************************************
 * Assign a var to the return value of the outer() function, 
 * so it points to the inner function
************************************************************/
const closure = outer();
...
/************************************************************
 * Call the generator function to return an object that can 
 * be iterated  to rturn a value each time the next method is 
 * called.
************************************************************/
...
/************************************************************
 * Ex. Write an instance that creates a new header using a 
...
/************************************************************
 * Provide the constructor with an optional argument 
 * containing any initial header values:
************************************************************/
