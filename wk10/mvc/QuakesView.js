 ...
 * Add the id of the quake record as a 
...
/*******************************************************
 * For the provided quake make a list of each of the 
 * properties associated with it. Then append the list to 
 * the provided element. Notice the first line of this 
 * method. Object.entries() is a slick way to turn an 
 * object into an array so that we can iterate over it 
 * easier!  
 *******************************************************/
